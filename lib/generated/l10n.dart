...
class S {
  ...
  String get allFieldsMustBeFilledIn {
    return Intl.message(
      'All fields must be filled in.',
      name: 'allFieldsMustBeFilledIn',
      desc: '',
      args: [],
    );
  }
  ...
  String get enterTheMapAddress {
    return Intl.message(
      'Enter the map address',
      name: 'enterTheMapAddress',
      desc: '',
      args: [],
    );
  }
